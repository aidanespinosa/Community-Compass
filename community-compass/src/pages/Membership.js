    ...
    return (
      <div className="membership" style={{ marginRight: 25 }}>
        ...
        <div>
          ...
          <ul>
            - Local neighborhood Crime Grade Rating for the provided address.
          </ul>
        ...
        <div>
          ...
          <ul>
            - Ratings of local recreational areas such as campsites, pools,
            museums, etc.
          </ul>
          <ul>
            - (optional) Access to the Megan's Law website for the provided
            address.
          </ul>
        </div>
        ...
        <form action="/create-checkout-session" method="POST">
          <input
            type="hidden"
            name="priceId"
            value="price_1MiVhgGGno84ND8Lt0DEwfqQ"
          />
